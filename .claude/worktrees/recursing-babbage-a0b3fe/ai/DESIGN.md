...
|----------|-------|-------|
| --color-background-default | #000000 | Page background |
...
## State & Feedback Color Tokens
| Property | Resolves To | Usage |
|----------|------------|-------|
| --color-state-hover | #4ADE6E | Hover highlight on interactive elements |
| --color-state-focus | #4ADE6E | Focus ring on focusable elements |
| --color-state-disabled | #8B9683 | Disabled text and icons (low contrast by design) |
| --color-feedback-error | #E05C5C | Error messages, invalid field indicators |
| --color-feedback-success | #4ADE6E | Success messages, confirmation indicators |
